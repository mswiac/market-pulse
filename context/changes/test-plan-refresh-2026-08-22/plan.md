...
- [x] 1.1 test-plan.md renders as valid Markdown with no broken table syntax — 3728697
- [x] 1.2 No remaining reference to `testing-bootstrap-pipeline-units` — 3728697
- [x] 1.3 No remaining stale "17 commits" figure — 3728697
- [x] 1.4 CLAUDE.md no longer claims Karma as the active test runner — 3728697

#### Manual

- [x] 1.5 Full read-through of updated test-plan.md confirms every risk/coverage/gate claim traces to research.md — 3728697
- [x] 1.6 All 4 rollout-phase scope notes match the six Key Discoveries — 3728697
- [x] 1.7 §5's gate table doesn't overclaim the local post-edit hook's status — 3728697
